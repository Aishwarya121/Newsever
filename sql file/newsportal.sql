...
--
CREATE TABLE `newsever`.`images` 
( `id` INT(10) NOT NULL AUTO_INCREMENT , 
  `image` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;

-- CREATE TABLE `newsever`.`images` ( `id` INT(11) NOT NULL , 
--   `name` VARCHAR(255) NOT NULL , 
--   `image` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB DEFAULT CHARSET=latin1;
